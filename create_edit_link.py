...
# I will write a completely new EditLink.jsx based on MyLinks.jsx states and UI.
edit_link_content = """import { useState, useEffect } from 'react';
      ...
      <header className="sticky top-0 z-40 bg-surface/80 backdrop-blur-xl border-b border-outline-variant/30 w-full">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-display font-semibold text-on-surface tracking-tight">Edit Link</h1>
        ...
        <section className="bg-surface-container-lowest p-6 sm:p-8 rounded-3xl border border-outline-variant/30 shadow-sm">
          ...
          <section className="bg-surface-container-lowest p-6 sm:p-8 rounded-3xl border border-outline-variant/30 shadow-sm">
            <div className="flex justify-between items-center mb-6 border-b border-outline-variant/20 pb-3">
              ...
              <button onClick={addEditRoutingRule} className="text-primary hover:bg-primary/10 font-label-sm uppercase tracking-wider text-[12px] bg-primary/5 px-4 py-1.5 rounded-full transition-colors cursor-pointer flex items-center gap-1">
            ...
            <div className="space-y-4">
              {editRoutingRules.length === 0 ? (
                <div className="text-center py-6 bg-surface-container/50 rounded-2xl border border-outline-variant/20 border-dashed">
                  <p className="text-label-md text-on-surface-variant">No routing rules configured.</p>
                  <p className="text-body-sm text-on-surface-variant/70 mt-1">Redirect users based on their OS or Device.</p>
                </div>
              ) : editRoutingRules.map((rule, index) => (
                <div key={index} className="flex flex-col sm:flex-row items-start sm:items-center gap-3 bg-surface-container p-4 rounded-2xl border border-outline-variant/20 group transition-all hover:border-primary/30">
          ...
          <section className="bg-surface-container-lowest p-6 sm:p-8 rounded-3xl border border-outline-variant/30 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div>
                <label className="block text-label-sm font-label-sm text-on-surface-variant uppercase tracking-wider mb-2">Source</label>
                <input 
                  type="text" 
                  value={editUtmSource}
              ...
              <div>
                <label className="block text-label-sm font-label-sm text-on-surface-variant uppercase tracking-wider mb-2">Medium</label>
                <input 
                  type="text" 
                  value={editUtmMedium}
              ...
              <div>
                <label className="block text-label-sm font-label-sm text-on-surface-variant uppercase tracking-wider mb-2">Campaign</label>
                <input 
                  type="text" 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-label-sm font-label-sm text-on-surface-variant uppercase tracking-wider mb-2">Term</label>
                <input 
                  type="text" 
                  value={editUtmTerm}
              ...
              <div>
                <label className="block text-label-sm font-label-sm text-on-surface-variant uppercase tracking-wider mb-2">Content</label>
                <input 
                  type="text" 
          ...
          <section className="bg-surface-container-lowest p-6 sm:p-8 rounded-3xl border border-outline-variant/30 shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              <label className="flex items-center gap-3 p-4 bg-surface-container border border-outline-variant/30 rounded-2xl cursor-pointer hover:border-primary/50 transition-colors">
                <input type="checkbox" checked={editTrackIp} onChange={(e) => setEditTrackIp(e.target.checked)} className="w-4 h-4 text-primary rounded border-outline-variant bg-surface-container-lowest focus:ring-primary focus:ring-2" />
                <span className="text-body-md text-on-surface font-medium select-none">Track IP</span>
              </label>
              <label className="flex items-center gap-3 p-4 bg-surface-container border border-outline-variant/30 rounded-2xl cursor-pointer hover:border-primary/50 transition-colors">
                <input type="checkbox" checked={editTrackBrowser} onChange={(e) => setEditTrackBrowser(e.target.checked)} className="w-4 h-4 text-primary rounded border-outline-variant bg-surface-container-lowest focus:ring-primary focus:ring-2" />
                <span className="text-body-md text-on-surface font-medium select-none">Track Browser</span>
              </label>
              <label className="flex items-center gap-3 p-4 bg-surface-container border border-outline-variant/30 rounded-2xl cursor-pointer hover:border-primary/50 transition-colors">
                <input type="checkbox" checked={editTrackOs} onChange={(e) => setEditTrackOs(e.target.checked)} className="w-4 h-4 text-primary rounded border-outline-variant bg-surface-container-lowest focus:ring-primary focus:ring-2" />
                <span className="text-body-md text-on-surface font-medium select-none">Track OS</span>
              </label>
              <label className="flex items-center gap-3 p-4 bg-surface-container border border-outline-variant/30 rounded-2xl cursor-pointer hover:border-primary/50 transition-colors">
                <input type="checkbox" checked={editTrackDevice} onChange={(e) => setEditTrackDevice(e.target.checked)} className="w-4 h-4 text-primary rounded border-outline-variant bg-surface-container-lowest focus:ring-primary focus:ring-2" />
                <span className="text-body-md text-on-surface font-medium select-none">Track Device</span>
              </label>
              <label className="flex items-center gap-3 p-4 bg-surface-container border border-outline-variant/30 rounded-2xl cursor-pointer hover:border-primary/50 transition-colors">
                <input type="checkbox" checked={editTrackReferrer} onChange={(e) => setEditTrackReferrer(e.target.checked)} className="w-4 h-4 text-primary rounded border-outline-variant bg-surface-container-lowest focus:ring-primary focus:ring-2" />
                <span className="text-body-md text-on-surface font-medium select-none">Track Referrer</span>
              </label>
            </div>
          </section>
      </main>
...
with open('frontend/src/pages/EditLink.jsx', 'w') as f:
    f.write(edit_link_content)
