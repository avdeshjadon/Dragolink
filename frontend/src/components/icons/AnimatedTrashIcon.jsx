  ...
  return (
    ...
    >
      ...
      <motion.g
        ...
        animate={shouldAnimate ? "deleting" : "idle"}
        style={{ transformOrigin: "50% 35%" }}
      >
        {/* Handle */}
        <path
          d="M42 28 V 18 C 42 15.8 43.8 14 46 14 H 54 C 56.2 14 58 15.8 58 18 V 28"
          stroke={lightRed}
          strokeWidth="6"
          fill="none"
        />
        ...
        {/* Lid Left */}
        <path
          d="M18 32 C 18 29.8 19.8 28 22 28 H 50 V 42 H 18 V 32 Z"
          fill={lightRed}
        />

        {/* Lid Right */}
        <path
          d="M50 28 H 78 C 80.2 28 82 29.8 82 32 V 42 H 50 V 28 Z"
          fill={darkRed}
        />
      </motion.g>
      ...
      >
        {/* Body Left */}
        <path
          d="M26 42 H 50 V 85 H 32 C 28.7 85 26 82.3 26 79 V 42 Z"
          fill={darkRed}
        />

        {/* Body Right */}
        <path
          d="M50 42 H 74 V 79 C 74 82.3 71.3 85 68 85 H 50 V 42 Z"
          fill={lightRed}
        />
