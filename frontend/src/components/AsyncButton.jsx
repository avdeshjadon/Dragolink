...
export default function AsyncButton({ 
  ...
  const isPending = externalLoading !== undefined ? externalLoading : internalLoading;
  ...
  return (
    <motion.button
      ...
      {...props}
    >
      <span className={`flex items-center justify-center gap-2 transition-opacity duration-300 ${isPending ? 'opacity-0' : 'opacity-100'}`}>
        {children}
      </span>
