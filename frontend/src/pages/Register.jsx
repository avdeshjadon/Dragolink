        ...
        <div className="mx-auto w-full max-w-sm">
          <div className="mb-10 text-center">
            ...
            <p className="mt-2 text-sm text-text-secondary">
              {otpSent ? `We sent a code to ${email}` : "Join Dragolink to master your links"}
            </p>
          </div>

          <form onSubmit={otpSent ? (e) => { e.preventDefault(); handleRegister(); } : handleSendOtp} className="space-y-5">
            {error && (
              <motion.div
