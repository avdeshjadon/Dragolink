  ...
  return (
    <div className="bg-bg-light min-h-screen font-sans">
      ...
      <section className="pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        {loading ? (
           <div className="text-center py-20 text-text-secondary">Loading posts...</div>
        ) : featuredPost ? (
          <motion.div
          ...
          role="button"
          tabIndex={0}
          onKeyDown={(e) => (e.key === 'Enter' || e.key === ' ') && goToPost(featuredPost.id)}
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 lg:gap-12 bg-surface-light rounded-[2rem] border border-border-light overflow-hidden shadow-xl hover:shadow-2xl hover:border-brand/30 transition-all duration-300">
            ...
            <div className="p-8 lg:p-12 flex flex-col justify-center">
              ...
              <div className="flex items-center justify-between mt-auto">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-bold text-brand-dark">{featuredPost.author}</p>
                    <p className="text-xs text-text-secondary">{featuredPost.readTime}</p>
                  </div>
                </div>
                <Button
                  variant="ghost"
                  className="group-hover:translate-x-2 transition-transform"
                  onClick={(e) => { e.stopPropagation(); goToPost(featuredPost.id); }}
                >
           ...
           <div className="text-center py-20 text-text-secondary">No featured post found.</div>
        )}
      </section>
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <div className="mt-auto flex items-center justify-between border-t border-border-light pt-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-text-primary font-medium">{post.author}</span>
                    </div>
          ...
          <div className="bg-brand-dark rounded-[2.5rem] p-10 md:p-16 relative overflow-hidden">
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 bg-white/5 p-2 rounded-2xl backdrop-blur-sm border border-white/10">
                ...
                <Button size="lg" className="h-14 px-8 bg-brand-emerald hover:bg-brand text-brand-dark hover:text-white shrink-0 shadow-lg">
