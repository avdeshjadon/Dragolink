...
const DEFAULT_TERMS = {
  ...
  sections: [
    { heading: "1. Acceptance of Terms", content: "By accessing or using the Dragolink platform, you agree to be bound by these Terms of Service. If you disagree with any part of the terms, then you may not access the service. These terms apply to all visitors, users, and others who access or use the Service." },
    { heading: "2. Description of Service", content: "Dragolink provides a comprehensive link management platform, including URL shortening, dynamic QR code generation, advanced analytics, and link routing infrastructure. We reserve the right to modify or discontinue, temporarily or permanently, the Service (or any part thereof) with or without notice." },
    { heading: "3. User Accounts", content: "When you create an account with us, you must provide us information that is accurate, complete, and current at all times. Failure to do so constitutes a breach of the Terms, which may result in immediate termination of your account on our Service.\n\nYou are responsible for safeguarding the password that you use to access the Service and for any activities or actions under your password." },
    { heading: "4. Acceptable Use Policy", content: "You agree not to use the Service to:\n\n- Link to malware, phishing sites, or any malicious content designed to harm or exploit users.\n- Distribute spam or engage in abusive marketing practices.\n- Violate any applicable laws, regulations, or third-party rights.\n- Interfere with or disrupt the integrity or performance of the Service.\n\nWe employ automated security scanning and reserve the right to immediately suspend accounts and disable links found violating these rules." },
    { heading: "5. Intellectual Property", content: "The Service and its original content, features, and functionality are and will remain the exclusive property of Dragolink and its licensors. The Service is protected by copyright, trademark, and other laws of both the United States and foreign countries. Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of Dragolink." },
    { heading: "6. Limitation of Liability", content: "In no event shall Dragolink, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from (i) your access to or use of or inability to access or use the Service; (ii) any conduct or content of any third party on the Service; (iii) any content obtained from the Service; and (iv) unauthorized access, use or alteration of your transmissions or content." }
  ]
};
