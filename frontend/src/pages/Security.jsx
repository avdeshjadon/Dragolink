...
export default function Security() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-bg-light text-brand font-mono">
  ...
  if (!data || !data.hero) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-bg-light text-gray-500 font-mono">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-6">
              ...
              <Button
                size="lg"
                variant="outline"
                className="h-14 px-8 cursor-pointer bg-white"
              >
      ...
      <section className="py-20 bg-white border-b border-border-light relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-sm font-mono text-gray-500 tracking-widest uppercase mb-2">
              Certifications & Compliance
            </h2>
            <p className="text-2xl font-bold text-gray-900">
              Independently verified by industry leaders.
            </p>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-500 max-w-2xl mx-auto">
                Built from the ground up to keep your organization safe.
              </p>
            </div>
        ...
        <section className="py-24 bg-white border-t border-border-light relative z-10">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-500 max-w-2xl mx-auto">
                In-depth information on how we handle and protect your data.
              </p>
            </div>
            ...
            <div className="space-y-16">
              {sections.map((section, idx) => (
                ...
                >
                  <h3 className="text-2xl font-bold text-gray-900 mb-6 border-b border-border-light pb-2">
                    {section.title}
                  </h3>
