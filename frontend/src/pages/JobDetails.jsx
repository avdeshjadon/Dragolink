    ...
    <div className="bg-bg-light min-h-screen font-sans pb-32 text-brand-dark">
      ...
      <div className="bg-surface-light border-b border-border-light pt-32 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link
            to="/careers"
            className="inline-flex items-center text-text-secondary hover:text-brand mb-8 transition-colors font-medium"
          >
        ...
        <div className="relative">
          <div className="sticky top-32 bg-white rounded-2xl border border-border-light p-6 shadow-xl shadow-brand/5">
            ...
            <p className="text-text-secondary text-sm mb-6">
              Submit your application below and our team will get back to you
              within 48 hours.
            </p>
            <Button
              size="lg"
              className="w-full h-14 bg-brand text-white text-lg font-bold hover:bg-brand-dark shadow-md cursor-pointer"
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <p className="text-gray-500 mb-8">
                You need to be logged into your Dragolink account to submit a
                job application.
              </p>
              <div className="flex flex-col gap-3">
                <Button
                  ...
                  onClick={() => {
                    ...
                    navigate("/login", {
                      state: { from: { pathname: `/careers/${jobId}/apply` } },
                    });
                  }}
                >
                  Log In or Sign Up
                ...
                <button
                  onClick={() => setShowAuthModal(false)}
                  className="py-2 text-sm font-medium text-gray-500 hover:text-gray-700 transition-colors cursor-pointer"
                >
                  Cancel
                </button>
              </div>
