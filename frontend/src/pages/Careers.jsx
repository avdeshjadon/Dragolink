...
export default function Careers() {
  ...
  return (
    <div className="bg-bg-light min-h-screen font-sans pb-32 text-brand-dark overflow-hidden">
      ...
      <section className="relative pt-32 pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <Button size="lg" className="h-14 px-8 bg-brand-dark text-white hover:bg-black shadow-xl" onClick={() => document.getElementById('jobs').scrollIntoView({ behavior: 'smooth' })}>
      ...
      <section className="py-24 bg-surface-light border-y border-border-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-extrabold text-brand-dark mb-4">Why work here?</h2>
            <p className="text-xl text-text-secondary max-w-2xl mx-auto">We invest heavily in our team so they can invest heavily in our product.</p>
          </div>
            ...
            {perks.map((perk, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-lg font-bold text-brand-dark mb-2">{perk.title}</h3>
                  <p className="text-text-secondary text-sm leading-relaxed">{perk.description}</p>
                </motion.div>
              )
            })}
          </div>
      ...
      {/* Jobs Board */}
      <section id="jobs" className="py-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-extrabold text-brand-dark mb-4">Open Positions</h2>
          <p className="text-xl text-text-secondary">Join us on our mission to secure the web's links.</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          {jobs.length === 0 && (
            <div className="text-center p-12 bg-surface-light rounded-2xl border border-dashed border-border-light">
              <p className="text-text-secondary font-medium">No open positions at the moment. Check back later!</p>
            </div>
          )}
        </div>
      </section>
