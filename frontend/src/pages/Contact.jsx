...
export default function Contact() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-bg-light text-brand">
          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <p className="text-text-secondary mb-10">
                Fill out the form below and our enterprise team will connect
                with you.
              </p>
                ...
                {formStatus === "success" ? (
                  ...
                  >
                    ...
                    <p className="text-text-secondary text-lg max-w-md">
                      Thank you for reaching out. A specialist will get back to
                      you within 24 hours.
                    </p>
                    <Button
                      className="mt-8"
                  ...
                  >
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          type="text"
                          className="w-full bg-bg-light border border-border-light rounded-xl px-4 py-3 focus:ring-2 focus:ring-brand focus:border-brand outline-none transition-all placeholder:text-gray-400"
                          placeholder="Jane"
                        />
                      </div>
                      <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        className="w-full bg-bg-light border border-border-light rounded-xl px-4 py-4 h-40 resize-none focus:ring-2 focus:ring-brand focus:border-brand outline-none transition-all placeholder:text-gray-400 leading-relaxed"
                        placeholder="Tell us about your link infrastructure needs, expected volume, or specific compliance requirements..."
                      />
                    </div>
                    ...
                    <Button
                      type="submit"
                      size="lg"
                      className="w-full h-14 text-lg mt-4 shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all cursor-pointer"
            ...
            >
              ...
              <div className="bg-white rounded-2xl p-8 border border-border-light shadow-sm">
                <h3 className="text-2xl font-bold mb-6 flex items-center gap-3 text-brand-dark">
                  <Building className="w-6 h-6 text-brand" /> Global Offices
                </h3>
                <div className="space-y-8">
                  {offices.map((office, idx) => (
                    <div key={idx} className="group">
                      <h4 className="font-bold text-lg mb-2 text-brand-dark group-hover:text-brand transition-colors">
                        {office.city}
                      </h4>
              ...
              <div className="bg-brand-dark rounded-2xl p-8 shadow-xl text-white relative overflow-hidden">
                ...
                <h3 className="text-2xl font-bold mb-6 flex items-center gap-3">
                  <Mail className="w-6 h-6 text-brand-emerald" /> Direct Contact
                </h3>
                  ...
                  {emails.map((item, idx) => (
                    <div key={idx}>
                      ...
                      <a
                        ...
                        className="text-lg font-medium text-white hover:text-brand-emerald transition-colors"
                      >
                        {item.email}
                      </a>
                    </div>
