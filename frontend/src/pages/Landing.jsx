    ...
    <div className="flex flex-col min-h-screen bg-bg-light w-full font-sans">
      ...
      <section className="relative pt-24 pb-32 overflow-hidden px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
          ...
          >
            Create powerful short links, track engagement, generate QR codes,
            and manage your entire link infrastructure from one intelligent
            platform.
          </motion.p>
      ...
      <section id="features" className="py-24 bg-bg-light relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            >
              Everything you need to <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand to-brand-emerald">scale</span>
            </motion.h2>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              Dragolink provides a comprehensive suite of tools designed for modern teams and creators who demand the best.
            </motion.p>
          </div>
      ...
      <section className="py-24 bg-brand-dark relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-xl text-border-light mb-10 max-w-2xl mx-auto">
            Join thousands of teams who trust Dragolink for their link
