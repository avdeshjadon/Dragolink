      ...
      <div className="min-h-screen bg-bg-light flex flex-col items-center justify-center p-4">
        ...
        >
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-md mx-auto">
            Thank you for applying to be a {job.title}. You can track your
    ...
    <div className="min-h-screen bg-bg-light font-sans text-brand-dark pb-20 pt-8">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 flex items-center justify-between">
          <Link
            to={`/careers/${jobId}`}
            className="inline-flex items-center text-text-secondary hover:text-brand transition-colors font-medium"
          >
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-border-light mb-8">
          <div className="flex justify-between items-center relative">
            ...
            {["Basic Info", "Education", "Experience", "Final Details"].map(
              (label, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      className={`text-xs font-semibold ${isActive || isPast ? "text-gray-900" : "text-gray-400"}`}
                    >
                      {label}
                    </span>
                  </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          type="text"
                          className="w-full p-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-brand outline-none transition-all"
                        />
                      </div>
                      <div className="space-y-2">
                        <label className="text-sm font-semibold text-gray-700">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          value={formData.seniorSecondaryPercentage}
                          onChange={handleChange}
                          type="number"
                          step="0.01"
                          min="0"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2 md:col-span-2">
                        ...
                        <select
                          ...
                          onChange={handleChange}
                          className="w-full p-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-brand outline-none transition-all bg-white"
                        >
                  ...
                  >
                    <section className="space-y-6">
                      ...
                      <p className="text-xs text-text-secondary">
                        Used to provision correct equipment for remote/hybrid
                        roles.
                      </p>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-2">
                          ...
                          <select
                            ...
                            value={formData.laptopProcessor}
                            onChange={handleChange}
                            className="w-full p-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-brand outline-none transition-all bg-white"
                          >
                            <option value="Intel i5 / AMD Ryzen 5 or equivalent">
                              Intel i5 / AMD Ryzen 5
                            </option>
                            <option value="Intel i7 / AMD Ryzen 7 or equivalent">
                              Intel i7 / AMD Ryzen 7
                            </option>
                            <option value="Intel i9 / AMD Ryzen 9 or equivalent">
                              Intel i9 / AMD Ryzen 9
                            </option>
                            <option value="Apple M-Series">
                              Apple M-Series
                            </option>
                          </select>
                        </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <textarea
                            ...
                            onChange={handleChange}
                            className="w-full p-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-brand outline-none transition-all h-32"
              ...
              <div className="mt-12 pt-6 border-t border-gray-100 flex items-center justify-between">
                ...
                {currentStep < totalSteps ? (
                  ...
                  <Button
                    ...
                    className="px-10 flex items-center gap-2 bg-brand text-white hover:bg-brand-dark shadow-lg shadow-brand/20"
                  >
