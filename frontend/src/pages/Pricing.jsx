    ...
    <div className="bg-bg-light min-h-screen py-24 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            {hero?.subtitle ||
              "Choose the plan that best fits your needs and start scaling your links today."}
          </motion.p>
          ...
          >
            <span
              className={`text-sm font-semibold ${!annual ? "text-brand-dark" : "text-text-secondary"}`}
            >
              Monthly billing
            </span>
            <button
            ...
            >
              <div
                className={`w-5 h-5 rounded-full bg-brand absolute top-0.5 transition-transform ${annual ? "translate-x-8" : "translate-x-1"}`}
              />
            </button>
            <span
              className={`text-sm font-semibold ${annual ? "text-brand-dark" : "text-text-secondary"}`}
            >
              Annual billing{" "}
              <span className="text-brand-emerald bg-brand-emerald/10 px-2 py-0.5 rounded ml-1 text-xs">
                Save 20%
              </span>
            </span>
          </motion.div>
