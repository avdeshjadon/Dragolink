...
import com.linkpulse.service.AnalyticsService;
...
public class AnalyticsController {
    ...
    public ResponseEntity<AnalyticsDashboardDto> getDashboard(@AuthenticationPrincipal UserDetails userDetails) {
        return ResponseEntity.ok(analyticsService.getDashboard(userDetails));
    }
